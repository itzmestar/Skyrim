package com.xenum.skyrim.com.xenum.skyrim.wifi;
...
import com.xenum.skyrim.R;
import com.xenum.skyrim.com.xenum.skyrim.wifi.WiFiDirectApp.PTPLog;

import java.nio.channels.SocketChannel;

import static com.xenum.skyrim.com.xenum.skyrim.wifi.Constants.*;
import static com.xenum.skyrim.com.xenum.skyrim.wifi.Constants.MSG_BROKEN_CONN;
import static com.xenum.skyrim.com.xenum.skyrim.wifi.Constants.MSG_FINISH_CONNECT;
import static com.xenum.skyrim.com.xenum.skyrim.wifi.Constants.MSG_NEW_CLIENT;
import static com.xenum.skyrim.com.xenum.skyrim.wifi.Constants.MSG_NULL;
import static com.xenum.skyrim.com.xenum.skyrim.wifi.Constants.MSG_PULLIN_DATA;
import static com.xenum.skyrim.com.xenum.skyrim.wifi.Constants.MSG_PUSHOUT_DATA;
import static com.xenum.skyrim.com.xenum.skyrim.wifi.Constants.MSG_REGISTER_ACTIVITY;
import static com.xenum.skyrim.com.xenum.skyrim.wifi.Constants.MSG_SELECT_ERROR;
import static com.xenum.skyrim.com.xenum.skyrim.wifi.Constants.MSG_STARTCLIENT;
import static com.xenum.skyrim.com.xenum.skyrim.wifi.Constants.MSG_STARTSERVER;
...
public class ConnectionService extends Service implements ChannelListener, PeerListListener, ConnectionInfoListener {  // callback of requestPeers{
    ...
    WiFiDirectApp mApp;
	WifiMainActivity mActivity;    // shall I use weak reference here ?
    ...
    private void processMessage(android.os.Message msg) {
        ...
        case MSG_REGISTER_ACTIVITY:
        	...
        	onActivityRegister((WifiMainActivity)msg.obj, msg.arg1);
        	break;
     ...
     */
    private void onActivityRegister(WifiMainActivity activity, int register){
    ...
    public void showNotification(MessageRow row) {
    	...
    	Intent notificationIntent = mApp.getLauchActivityIntent(WifiMainActivity.class, row.mMsg);
