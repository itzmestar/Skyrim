...
import com.xenum.skyrim.com.xenum.skyrim.wifi.DeviceListFragment.DeviceActionListener;
import com.xenum.skyrim.com.xenum.skyrim.wifi.WiFiDirectApp.PTPLog;

//import static com.colorcloud.wifichat.Constants.*;
import static com.xenum.skyrim.com.xenum.skyrim.wifi.Constants.ACT_CREATE;
import static com.xenum.skyrim.com.xenum.skyrim.wifi.Constants.CAT_LOCATION;
import static com.xenum.skyrim.com.xenum.skyrim.wifi.Constants.LAB_HOME;
...
public class WiFiDirectActivity extends Activity implements DeviceActionListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.wifimain);   // statically draw two <fragment class=>
        ...
        switch (item.getItemId()) {
            ...
            case R.id.atn_direct_enable:
            	if( !mApp.isP2pEnabled() ){
                    ...
                    Toast.makeText(this, "WiFi direct support : already enabled.", Toast.LENGTH_LONG).show();
                }
                return true;
            ...
            case R.id.about:
            	...
            	Toast.makeText(this, "Its Legen Wait For It Dary... Legendary", Toast.LENGTH_LONG).show();
            	return true;
            	
            case R.id.help:
            	PTPLog.d(TAG, "onOptionsItemSelected : help ");
            	Toast.makeText(this, "Ask Mr. Tarique Anwer for help. He is your saviour", Toast.LENGTH_LONG).show();
            	return true;
    ...
    public void startChatActivity(final String initMsg) {
    	...
    	runOnUiThread(new Runnable() {
    		@Override
            public void run() {
    			Intent i = mApp.getLauchActivityIntent(WifiMainActivity.class, initMsg);
    	    	startActivity(i);
    		}
    	});
    }
